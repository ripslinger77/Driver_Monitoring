...
while True:
    ...
    '''cv2.putText(color_image, str(gyro_x), (10, 60), font, 1, (0, 0, 255), 2, cv2.LINE_AA)
    cv2.putText(color_image, str(gyro_y), (10, 90), font, 1, (0, 0, 255), 2, cv2.LINE_AA)
    cv2.putText(color_image, str(gyro_z), (10, 120), font, 1, (0, 0, 255), 2, cv2.LINE_AA)'''

    #cv2.putText(color_image, str(gp.gps()), (10, 60), font, 1, (0, 0, 255), 2, cv2.LINE_AA)
    cv2.putText(color_image, str(com.compass()), (10, 90), font, 1, (0, 0, 255), 2, cv2.LINE_AA)
